...
class DiSENN(nn.Module):
    ...
    def forward(self, x):
        ...
        """
        concept_mean, concept_logvar, x_reconstruct = self.conceptizer(x)
    ...
    def explain(self, x, contrast_class = None, num_prototypes=20, traversal_range=0.45, use_cdf=True,
        ...
        concepts_sample = self.conceptizer.sample(x_posterior_mean,
        ...
        prototypes = self.conceptizer.decoder(concepts_traversals)
